...
INSERT INTO `categories` (`id`, `parent_id`, `name`, `slug`, `description`, `image_url`, `banner_url`, `sort_order`, `status`, `seo_title`, `seo_description`, `created_at`, `updated_at`) VALUES ('1', NULL, 'Women', 'women', 'ARILHA Jewellery Catalogue', NULL, NULL, '1', 'ACTIVE', 'Jewellery Collection | ARILHA', 'Discover modern Indian jewellery by Irsa Khan at ARILHA.', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `categories` (`id`, `parent_id`, `name`, `slug`, `description`, `image_url`, `banner_url`, `sort_order`, `status`, `seo_title`, `seo_description`, `created_at`, `updated_at`) VALUES ('2', '1', 'Kundan & Festive Jewellery', 'kundan-festive', 'Exquisite handcrafted Kundan chokers, bridal necklaces, and royal festive jewellery.', NULL, NULL, '1', 'ACTIVE', 'Kundan & Bridal Jewellery | ARILHA', 'Explore handcrafted Kundan chokers and royal bridal jewellery at ARILHA.', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `categories` (`id`, `parent_id`, `name`, `slug`, `description`, `image_url`, `banner_url`, `sort_order`, `status`, `seo_title`, `seo_description`, `created_at`, `updated_at`) VALUES ('3', '1', 'Everyday & Anti-Tarnish Jewellery', 'everyday-jewellery', 'Modern anti-tarnish hoops, gold-plated stacking rings, layered chains, and daily bangles.', NULL, NULL, '2', 'ACTIVE', 'Anti-Tarnish & Gold-Plated Jewellery | ARILHA', 'Explore modern anti-tarnish and gold-plated everyday jewellery by Irsa Khan.', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('1', 'welcome_email', 'Welcome Email', 'Sent to new customers upon account registration.', 'customer', '1', 'Welcome to ARILHA - Modern Indian Jewellery', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('2', 'order_confirmation', 'Order Confirmation', 'Sent after payment verification or COD checkout.', 'customer', '1', 'Order Confirmation - ARILHA #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('3', 'payment_confirmation', 'Payment Receipt', 'Sent after successful Razorpay payment verification.', 'customer', '1', 'Payment Received for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('4', 'order_processing', 'Order Processing', 'Sent when order status changes to Processing.', 'customer', '1', 'Your Order #{order_number} is being Processed', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('5', 'order_shipped', 'Order Shipped', 'Sent when order status changes to Shipped.', 'customer', '1', 'Your Order #{order_number} has been Shipped!', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('6', 'order_delivered', 'Order Delivered', 'Sent when order status changes to Delivered.', 'customer', '1', 'Your Order #{order_number} has been Delivered', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('7', 'return_requested', 'Return Requested', 'Sent to customer when return request is submitted.', 'customer', '1', 'Return Request Received for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('8', 'return_approved', 'Return Approved', 'Sent when admin approves a return request.', 'customer', '1', 'Return Request Approved for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('9', 'return_rejected', 'Return Rejected', 'Sent when admin rejects a return request.', 'customer', '1', 'Update on Return Request for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('10', 'refund_initiated', 'Refund Initiated', 'Sent when refund processing is initiated.', 'customer', '1', 'Refund Initiated for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('11', 'refund_completed', 'Refund Completed', 'Sent when refund is completed.', 'customer', '1', 'Refund Processed Successfully for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('12', 'password_reset', 'Password Reset', 'Sent when customer requests password reset link.', 'customer', '1', 'Reset Your ARILHA Account Password', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('13', 'admin_new_order', 'Admin: New Order Placed', 'Notification to admin when a new order is verified.', 'admin', '1', '[ALERT] New Order Placed #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('14', 'admin_new_return', 'Admin: New Return Request', 'Notification to admin when customer files return.', 'admin', '1', '[ALERT] New Return Request for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
INSERT INTO `email_notification_settings` (`id`, `event_key`, `name`, `description`, `recipient_type`, `is_enabled`, `subject_template`, `created_at`, `updated_at`) VALUES ('15', 'admin_payment_failure', 'Admin: Payment Failure', 'Notification to admin when payment verification fails.', 'admin', '1', '[ALERT] Payment Verification Failed for Order #{order_number}', '2026-09-23 10:49:43', '2026-09-23 10:49:43');
...
INSERT INTO `homepage_sections` (`id`, `type`, `title`, `subtitle`, `content`, `image_url`, `button_text`, `button_url`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('1', 'HERO', 'ARILHA Jewellery Collection 2026', 'Modern Indian Jewellery by Irsa Khan', NULL, NULL, NULL, NULL, '1', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `homepage_sections` (`id`, `type`, `title`, `subtitle`, `content`, `image_url`, `button_text`, `button_url`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('2', 'CATEGORY_GRID', 'Shop By Category', 'Explore Kundan, Anti-Tarnish & Everyday Edits', NULL, NULL, NULL, NULL, '2', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `homepage_sections` (`id`, `type`, `title`, `subtitle`, `content`, `image_url`, `button_text`, `button_url`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('3', 'PRODUCT_GRID', 'Fresh New Arrivals', 'Handpicked for You', NULL, NULL, NULL, NULL, '3', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `homepage_sections` (`id`, `type`, `title`, `subtitle`, `content`, `image_url`, `button_text`, `button_url`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('4', 'BANNER', 'Flat 10% Off Your First Order', 'Use code WELCOME10 at checkout', NULL, NULL, NULL, NULL, '4', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('1', '1', '20', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('2', '2', '15', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('3', '3', '30', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('4', '4', '25', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('5', '5', '40', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `inventory` (`id`, `variant_id`, `available_quantity`, `reserved_quantity`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES ('6', '6', '35', '0', '5', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('1', 'products.view', 'catalog', 'View products', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('2', 'products.create', 'catalog', 'Create products and variants', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('3', 'products.update', 'catalog', 'Update products and variants', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('4', 'products.delete', 'catalog', 'Delete products', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('5', 'categories.view', 'catalog', 'View categories', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('6', 'categories.create', 'catalog', 'Create categories', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('7', 'categories.update', 'catalog', 'Update categories', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('8', 'categories.delete', 'catalog', 'Delete categories', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('9', 'inventory.view', 'inventory', 'View inventory stock balances', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('10', 'inventory.update', 'inventory', 'Adjust stock and record inventory transactions', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('11', 'orders.view', 'orders', 'View order history', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('12', 'orders.update', 'orders', 'Update order processing status', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('13', 'orders.cancel', 'orders', 'Cancel orders', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('14', 'orders.refund', 'orders', 'Issue order refunds', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('15', 'customers.view', 'customers', 'View customer profiles', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('16', 'customers.update', 'customers', 'Update customer status', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('17', 'reviews.view', 'reviews', 'View product reviews', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('18', 'reviews.moderate', 'reviews', 'Approve or reject customer reviews', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('19', 'coupons.view', 'marketing', 'View promo coupons', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('20', 'coupons.create', 'marketing', 'Create coupons', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('21', 'coupons.update', 'marketing', 'Update coupons', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('22', 'coupons.delete', 'marketing', 'Disable or delete coupons', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('23', 'offers.view', 'marketing', 'View promotional offers', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('24', 'offers.create', 'marketing', 'Create offers', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('25', 'offers.update', 'marketing', 'Update offers', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('26', 'offers.delete', 'marketing', 'Delete offers', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('27', 'homepage.view', 'cms', 'View homepage section layouts', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('28', 'homepage.update', 'cms', 'Update homepage sections', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('29', 'banners.view', 'cms', 'View hero banners', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('30', 'banners.create', 'cms', 'Create hero banners', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('31', 'banners.update', 'cms', 'Update hero banners', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('32', 'banners.delete', 'cms', 'Delete hero banners', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('33', 'popups.view', 'cms', 'View promotional popups', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('34', 'popups.create', 'cms', 'Create popups', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('35', 'popups.update', 'cms', 'Update popups', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('36', 'popups.delete', 'cms', 'Delete popups', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('37', 'reports.view', 'reports', 'View sales & analytics dashboard reports', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('38', 'settings.view', 'settings', 'View system settings', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('39', 'settings.update', 'settings', 'Update store settings', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('40', 'users.view', 'users', 'View admin users', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('41', 'users.create', 'users', 'Create admin users', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('42', 'users.update', 'users', 'Update admin users and roles', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `permissions` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES ('43', 'users.delete', 'users', 'Disable or remove admin users', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
...
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('1', '1', NULL, NULL, 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?q=80&w=1200&auto=format&fit=crop', NULL, '1', '1', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('2', '1', NULL, NULL, 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=1200&auto=format&fit=crop', NULL, '2', '0', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('3', '2', NULL, NULL, 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=1200&auto=format&fit=crop', NULL, '1', '1', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('4', '3', NULL, NULL, 'https://images.unsplash.com/photo-1611591475140-4388636a26f6?q=80&w=1200&auto=format&fit=crop', NULL, '1', '1', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('5', '4', NULL, NULL, 'https://images.unsplash.com/photo-1630019852942-f89202989a59?q=80&w=1200&auto=format&fit=crop', NULL, '1', '1', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_images` (`id`, `product_id`, `product_variant_id`, `color_name`, `image_url`, `alt_text`, `sort_order`, `is_primary`, `created_at`, `updated_at`) VALUES ('6', '5', NULL, NULL, 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?q=80&w=1200&auto=format&fit=crop', NULL, '1', '1', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('1', '1', 'ARL-CHK-001-GLD-FS', 'Free Size', 'Royal Gold', NULL, '3499.00', '4999.00', '20', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('2', '1', 'ARL-CHK-001-GRN-FS', 'Free Size', 'Emerald Green', NULL, '3499.00', '4999.00', '15', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('3', '2', 'ARL-JHM-001-GLD-FS', 'Free Size', 'Gold', NULL, '1599.00', '2299.00', '30', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('4', '3', 'ARL-BRC-001-GLD-FS', 'Free Size', 'Warm Gold', NULL, '1899.00', '2499.00', '25', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('5', '4', 'ARL-HOP-001-GLD-FS', 'Free Size', 'Classic Gold', NULL, '1299.00', '1799.00', '40', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `color_code`, `price`, `mrp`, `stock`, `low_stock_threshold`, `status`, `created_at`, `updated_at`) VALUES ('6', '5', 'ARL-RNG-001-RSG-FS', 'Free Size', 'Rose Gold', NULL, '999.00', '1499.00', '35', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('1', 'SUPER_ADMIN', 'Super Administrator', 'Full unrestricted system access', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('2', 'ADMIN', 'Administrator', 'General store administration', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('3', 'PRODUCT_MANAGER', 'Product Manager', 'Catalog, category, and collection management', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('4', 'INVENTORY_MANAGER', 'Inventory Manager', 'Stock balance adjustments and warehouse tracking', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('5', 'ORDER_MANAGER', 'Order Manager', 'Order fulfillment and shipping updates', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES ('6', 'MARKETING_MANAGER', 'Marketing Manager', 'Coupons, offers, hero banners, and popups', '2026-09-23 10:49:48', '2026-09-23 10:49:48');
...
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('1', 'general', 'store_name', 'ARILHA', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('2', 'general', 'store_currency', 'INR', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('3', 'general', 'currency_symbol', '₹', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('4', 'shipping', 'free_shipping_threshold', '1499', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('5', 'seo', 'default_meta_title', 'ARILHA — Modern Indian Jewellery | Anti-Tarnish & Everyday Jewellery', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `settings` (`id`, `group_name`, `key_name`, `value_content`, `created_at`, `updated_at`) VALUES ('6', 'seo', 'default_meta_description', 'Discover ARILHA by Irsa Khan — modern Indian jewellery designed for everyday wear, celebrations and every version of you.', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `shipping_methods` (`id`, `name`, `description`, `price`, `estimated_min_days`, `estimated_max_days`, `status`, `created_at`, `updated_at`) VALUES ('1', 'Standard Delivery', 'Reliable doorstep delivery across India in 3–5 business days.', '49.00', '3', '5', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `shipping_methods` (`id`, `name`, `description`, `price`, `estimated_min_days`, `estimated_max_days`, `status`, `created_at`, `updated_at`) VALUES ('2', 'Express Delivery', 'Priority express delivery in 1–2 business days.', '99.00', '1', '2', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `tax_rules` (`id`, `name`, `rate_percentage`, `is_inclusive`, `status`, `created_at`, `updated_at`) VALUES ('1', 'GST Jewellery 3%', '3.00', '0', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `users` (`id`, `name`, `email`, `google_id`, `provider`, `avatar`, `phone`, `password`, `user_type`, `status`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES ('1', 'ARILHA Administrator', 'admin@arilha.com', NULL, 'local', NULL, '9999999999', '$2y$12$QRL5boCWL9RVxUa9pnHiI.J9pcpKRKw3gj0ZY1zZpC2hpS31t0rm.', 'ADMIN', 'ACTIVE', '2026-09-23 10:49:49', NULL, '2026-09-23 10:49:49', '2026-09-23 10:49:49');
...
INSERT INTO `visitor_sessions` (`id`, `session_id`, `ip_address`, `user_agent`, `first_seen_at`, `last_seen_at`, `status`, `created_at`, `updated_at`) VALUES ('1', 'vs_5uict7bzh_1790084112956', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/153.0.0.0 Safari/537.36', '2026-09-23 10:48:26', '2026-09-23 10:50:25', 'ACTIVE', '2026-09-23 10:48:26', '2026-09-23 10:50:25');
...
INSERT INTO `watch_and_shop_videos` (`id`, `title`, `video_url`, `poster_url`, `product_url`, `button_text`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('1', 'Royal Kundan Choker Styling', 'https://assets.mixkit.co/videos/preview/mixkit-woman-posing-for-the-camera-in-a-studio-41337-large.mp4', 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?q=80&w=600&auto=format&fit=crop', '/product/royal-kundan-choker-necklace-set', 'View Product', '1', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `watch_and_shop_videos` (`id`, `title`, `video_url`, `poster_url`, `product_url`, `button_text`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('2', 'Handcrafted Pearl Drop Jhumkas', 'https://assets.mixkit.co/videos/preview/mixkit-fashion-model-in-a-red-dress-41334-large.mp4', 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=600&auto=format&fit=crop', '/product/handcrafted-pearl-drop-jhumkas', 'View Product', '2', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');
INSERT INTO `watch_and_shop_videos` (`id`, `title`, `video_url`, `poster_url`, `product_url`, `button_text`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES ('3', 'Anti-Tarnish Everyday Hoops', 'https://assets.mixkit.co/videos/preview/mixkit-young-woman-posing-in-a-flower-field-41335-large.mp4', 'https://images.unsplash.com/photo-1630019852942-f89202989a59?q=80&w=600&auto=format&fit=crop', '/product/anti-tarnish-daily-gold-hoops', 'View Product', '3', 'ACTIVE', '2026-09-23 10:49:49', '2026-09-23 10:49:49');

    ...
    public function up(): void
    {
        ...
        $defaults = [
            ...
            [
                ...
                'is_enabled' => true,
                'subject_template' => 'Welcome to ARILHA - Modern Indian Jewellery',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'recipient_type' => 'customer',
                'is_enabled' => true,
                'subject_template' => 'Order Confirmation - ARILHA #{order_number}',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
            ...
            [
                ...
                'recipient_type' => 'customer',
                'is_enabled' => true,
                'subject_template' => 'Reset Your ARILHA Account Password',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            // Admin Notifications
